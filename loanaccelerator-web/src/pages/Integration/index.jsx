...
import Documents from '../../components/forms/LoanDocuments';
import Personal from '../../components/forms/PersonalInformationPage';
import Addressinfo from '../../components/forms/Addressinformation';
import Family from '../../components/forms/Familyandemergency';
import Employement from '../../components/forms/Employement';
import FinancialInformationForm from '../../components/forms/FinancialInfo';
...
function Integration() {
  ...
  const { loanid , setloanid ,setNewAmount, setNewTenure, setNewFullName, setNewDob, setNewTaxId, setNewPermanent, setNewMobile1, setNewTelephone, setNewSpouse, setNewMobile3, setNewRelationship, setNewContact, setNewMobile2, setNewCompName, setNewPhone, setNewDesignation, setNewIncome, setNewExpenses , setNewDateOfBirth,setReceivedStage,receivedStage} = useContext(ApiContext);
