...
Alter table "User" Add UserName nvarchar(max); 

Alter table "User" Add HashKey varbinary(max);

ALTER TABLE [User]
ALTER COLUMN RoleId NVARCHAR(MAX);
ALTER TABLE [User]
...
EXEC sp_rename 'User.RoleId', 'Role', 'COLUMN';
Select * from "User";
--LoanCategory
